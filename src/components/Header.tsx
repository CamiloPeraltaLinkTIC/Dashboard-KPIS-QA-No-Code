        ...
        <div className="user-profile">
          ...
          <div className="profile-info">
            ...
            <span className="user-role">
              {profile?.role === 'leader' ? 'Líder' : (profile?.role === 'admin' || profile?.role === 'Administrator') ? 'Admin' : (profile?.role === 'dev' || profile?.role === 'Developer') ? 'Desarrollador' : 'QA'}
              {profile?.is_admin && profile?.role !== 'admin' && profile?.role !== 'Administrator' ? ' · Admin' : ''}
            </span>
          </div>
